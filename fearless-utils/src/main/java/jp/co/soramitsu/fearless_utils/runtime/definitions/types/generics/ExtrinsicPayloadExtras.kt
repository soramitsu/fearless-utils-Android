...
class SignedExtras(context: RuntimeSnapshot) : ExtrinsicPayloadExtras(
    name = "SignedExtras",
    extrasMapping = mapOf(
...
class AdditionalExtras(context: RuntimeSnapshot) : ExtrinsicPayloadExtras(
