...
import jp.co.soramitsu.schema.definitions.types.generics.BitVec
import jp.co.soramitsu.schema.definitions.types.generics.Bytes
import jp.co.soramitsu.schema.definitions.types.generics.CallBytes
import jp.co.soramitsu.schema.definitions.types.generics.Data
import jp.co.soramitsu.schema.definitions.types.generics.EraType
import jp.co.soramitsu.schema.definitions.types.generics.EventRecord
import jp.co.soramitsu.schema.definitions.types.generics.Extrinsic
import jp.co.soramitsu.schema.definitions.types.generics.GenericAccountId
import jp.co.soramitsu.schema.definitions.types.generics.GenericCall
import jp.co.soramitsu.schema.definitions.types.generics.GenericConsensus
import jp.co.soramitsu.schema.definitions.types.generics.GenericConsensusEngineId
import jp.co.soramitsu.schema.definitions.types.generics.GenericEvent
import jp.co.soramitsu.schema.definitions.types.generics.GenericMultiAddress
import jp.co.soramitsu.schema.definitions.types.generics.GenericSeal
import jp.co.soramitsu.schema.definitions.types.generics.GenericSealV0
import jp.co.soramitsu.schema.definitions.types.generics.H160
import jp.co.soramitsu.schema.definitions.types.generics.H256
import jp.co.soramitsu.schema.definitions.types.generics.H512
import jp.co.soramitsu.schema.definitions.types.generics.Null
import jp.co.soramitsu.schema.definitions.types.generics.OpaqueCall
import jp.co.soramitsu.schema.definitions.types.generics.SessionKeysSubstrate
