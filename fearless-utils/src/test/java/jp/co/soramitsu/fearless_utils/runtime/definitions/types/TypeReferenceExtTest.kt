...
class TypeReferenceExtTest {
    ...
    fun `should return self if not alias`() {
        ...
        assertEquals(typeRef, typeRef.resolveAliasing())
    }
    ...
    fun `should resolve one-level alias`() {
        ...
        assertEquals(typeRef, TypeReference(alias).resolveAliasing())
    }
    ...
    fun `should resolve multiple-level alias`() {
        ...
        assertEquals(typeRef, TypeReference(alias2).resolveAliasing())
    }
